...
public class UntreatedFragment extends TabFragment {
  private ExpandableListView mExpandableListView ;
  List<OrderInfo>mOrderInfoList=new ArrayList<>();

  //这个构造方法是便于各导航同时调用一个fragment
  public UntreatedFragment(String title){
    super(title);
  ...
  public void onActivityCreated(@Nullable Bundle savedInstanceState) {
    ...
    OrderListAdapter orderListAdapter = new OrderListAdapter(mOrderInfoList,OrderFragment.getOrderDetailList());
