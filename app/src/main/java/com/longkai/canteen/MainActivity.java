...
import com.longkai.canteen.fragment.FindFragment;
import com.longkai.canteen.fragment.OrderFragment;
import com.longkai.canteen.fragment.ProfileFragment;
...
public class MainActivity extends AppCompatActivity {
  ...
  private Fragment getTabFragment(int index, String title) {
    ...
    switch (index) {
      case INDEX_WEIXIN:
        fragment = DishFragment.newInstance(title);
        break;

      case INDEX_CONTACT:
        fragment = OrderFragment.newInstance(title);
        break;
